...
export const siteConfig: SiteConfig = {
  language: "en",
  siteName: "ReliantAI",
  siteDescription: "Premium HVAC growth systems. Tailored SEO & Geo-targeted websites that attract, qualify, and convert.",
  owner: {
...
export const footerConfig: FooterConfig = {
  ...
  contact: [
    ...
    {
      type: "phone",
      label: "+1-832-947-7028",
      value: "+1-832-947-7028",
      href: "tel:+18329477028",
    },
  ],
  locationLabel: "Location",
  address: ["Houston, TX", "Serving Businesses Everywhere"],
  socialLabel: "Connect",
  socials: [
    {
      platform: "linkedin",
  ...
  logoText: "ReliantAI",
  copyright: "© 2025 ReliantAI.org | Douglas Mitchell. All rights reserved.",
  links: [
