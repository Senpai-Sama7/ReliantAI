...
def test_site_registration_service_register(mock_get_db, _mock_revalidate):
    mock_db = MagicMock()
    ...
    copy_package = {
        "hero": {
            ...
            "subheadline": "Same-day HVAC",
            "trust_bar": ["Licensed", "Insured", "Certified"],
        },
        "services": [],
        "about": {"story": "Family owned.", "trust_points": []},
        "faq": [],
        "seo": {"title": "Apex HVAC Houston", "description": "Best HVAC in Houston"},
        "reviews": {"reviews": [], "aggregate_line": "4.8 stars"},
    }
    research_data = {
        "name": "Apex HVAC",
        "trade": "hvac",
