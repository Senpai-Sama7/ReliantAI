...
saga_failed = Counter("saga_failed_total", "Total sagas failed", ["saga_type", "reason"])
saga_compensated = Counter("saga_compensated_total", "Total sagas compensated", ["saga_type"])
saga_duration = Histogram("saga_duration_seconds", "Saga execution duration", ["saga_type"])
    ...
    try:
        ...
        for i, step in enumerate(saga.steps):
            ...
            try:
                ...
                logger.error("step_failed", saga_id=saga.saga_id, step=step.name, error=str(e))
                ...
                saga_failed.labels(saga_type=saga.saga_type, reason="step_failure").inc()
