...
/**
 * Numbered editorial services — deliberate asymmetry, never grid-cols-3 equal cards.
 */
    ...
    <section className="relative py-24 bg-[var(--trade-surface)]">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6">
        <ScrollReveal className="max-w-2xl mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-display text-white tracking-tight leading-[1.1]">
            {copy.services_title}
          </h2>
          ...
          {services.map((service, i) => {
            ...
            return (
              <ScrollReveal
                ...
                className={
                  featured
                    ? "lg:col-span-12 border-t border-white/10 pt-10"
