  ...
  return (
    <section className="relative min-h-[85svh] flex items-end overflow-hidden bg-[var(--trade-ink)] atmosphere-grain pt-14">
      <div
        ...
        style={{
          background:
            "radial-gradient(ellipse 68% 54% at 18% 22%, color-mix(in oklab, var(--trade-accent) 15%, transparent) 0%, transparent 66%)",
        }}
        aria-hidden
      />
      <div
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 pt-24 lg:pb-24 lg:pt-32">
        <div className="max-w-3xl">
          <div className="flex items-end gap-4">
            <p className="font-display text-[clamp(2.9rem,7.4vw,5.8rem)] leading-[0.95] tracking-[-0.035em] text-white">
              {business.business_name}
            </p>
            <span className="hidden sm:inline-block pb-2 text-[0.65rem] font-semibold uppercase tracking-[0.28em] text-[var(--trade-accent)]">
              24/7
            </span>
          </div>
          <div className="mt-5 h-px w-24 bg-[var(--trade-accent)]" aria-hidden />
