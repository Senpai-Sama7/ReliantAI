    ...
    <section className="relative py-28 bg-[var(--trade-ink)] overflow-hidden">
      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6">
        <ScrollReveal className="mb-14">
          ...
          <div className="mt-8 space-y-6 text-slate-300 leading-relaxed text-base sm:text-lg max-w-3xl">
            ...
            {business.years_in_business && (
              <p className="text-[var(--trade-accent)] font-medium">
        ...
        {about.trust_points.length > 0 && (
          <ScrollReveal delayMs={80} className="mt-16 border-l-2 border-[var(--trade-accent)]/45 pl-8 sm:pl-10">
