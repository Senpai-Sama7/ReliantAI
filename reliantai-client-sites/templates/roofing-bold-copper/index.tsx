...
export default function RoofingTemplate({ content }: { content: SiteContent }) {
  ...
  return (
    <div data-trade="roofing" className="template-shell bg-[var(--trade-ink)] text-white">
      <ContactBar content={content} tagline="Free inspections · Storm ready" />
      <BrandHero content={content} signature="copper-bold" />
