...
const MOCK_DATA: Record<string, SiteContent> = {
  "hvac-reliable-blue": makeContent({
    ...
    site_config: { template_id: "hvac-reliable-blue", trade: "hvac", theme: { primary: "#3d5a73", accent: "#6b8fa8", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "plumbing-trustworthy-navy": makeContent({
    ...
    site_config: { template_id: "plumbing-trustworthy-navy", trade: "plumbing", theme: { primary: "#1e3a5f", accent: "#c45c26", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "electrical-sharp-gold": makeContent({
    ...
    site_config: { template_id: "electrical-sharp-gold", trade: "electrical", theme: { primary: "#9a6b1f", accent: "#d4a017", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "roofing-bold-copper": makeContent({
    ...
    site_config: { template_id: "roofing-bold-copper", trade: "roofing", theme: { primary: "#9a4520", accent: "#c46a35", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "painting-clean-minimal": makeContent({
    ...
    site_config: { template_id: "painting-clean-minimal", trade: "painting", theme: { primary: "#8b6914", accent: "#a67c2a", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "landscaping-earthy-green": makeContent({
    ...
    site_config: { template_id: "landscaping-earthy-green", trade: "landscaping", theme: { primary: "#3d5c3d", accent: "#a67c52", font_display: "Instrument Serif", font_body: "DM Sans" } },
