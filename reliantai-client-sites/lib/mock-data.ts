...
const MOCK_DATA: Record<string, SiteContent> = {
  "hvac-reliable-blue": makeContent({
    ...
    site_config: { template_id: "hvac-reliable-blue", trade: "hvac", theme: { primary: "#1e40af", accent: "#60a5fa", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "plumbing-trustworthy-navy": makeContent({
    ...
    reviews: {
      reviews: MOCK_REVIEWS.map((r, i) => ({
        ...
        text: [
          "Pipe over a weekend and they answered immediately. Fixed in 45 minutes before the kitchen flooded.",
    ...
    site_config: { template_id: "plumbing-trustworthy-navy", trade: "plumbing", theme: { primary: "#1e3a5f", accent: "#1d4ed8", font_display: "Instrument Serif", font_body: "DM Sans" } },
    slug: "pipeshield-plumbing-denver",
  ...
  "electrical-sharp-gold": makeContent({
    ...
    site_config: { template_id: "electrical-sharp-gold", trade: "electrical", theme: { primary: "#78350f", accent: "#d97706", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "roofing-bold-copper": makeContent({
    ...
    site_config: { template_id: "roofing-bold-copper", trade: "roofing", theme: { primary: "#7c2d12", accent: "#ea580c", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "painting-clean-minimal": makeContent({
    ...
    site_config: { template_id: "painting-clean-minimal", trade: "painting", theme: { primary: "#1c1917", accent: "#b45309", font_display: "Instrument Serif", font_body: "DM Sans" } },
  ...
  "landscaping-earthy-green": makeContent({
    ...
    site_config: { template_id: "landscaping-earthy-green", trade: "landscaping", theme: { primary: "#14532d", accent: "#22c55e", font_display: "Instrument Serif", font_body: "DM Sans" } },
