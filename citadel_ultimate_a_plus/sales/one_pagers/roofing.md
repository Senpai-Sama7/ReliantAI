# Citadel for Roofing Operators (Harris County, TX)

## What It Is

Citadel is a local-first outbound pipeline for Roofing businesses that need more qualified conversations and better pipeline visibility.
...
Most Roofing outbound efforts break in three places:
- Broad lists with poor intent qualification
- Low-response outreach after estimate windows
- Weak handoff visibility between sales and production
...
## Why This Fits Roofing

- `roofing` is a configured target vertical in this repo (`market/target_verticals.json`).
- GTM angle: storm-window responsiveness + estimate conversion.
...
If you want, we can run a 7-day Roofing pilot and review results in a single weekly dashboard.
