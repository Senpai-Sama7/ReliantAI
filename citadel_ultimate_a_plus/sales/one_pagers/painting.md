# Citadel for Painting Operators (Harris County, TX)

## What It Is

Citadel is a local-first outbound pipeline for Painting businesses that need more qualified conversations and better pipeline visibility.
...
Most Painting outbound efforts break in three places:
- Targeting too broad for profitable project mix
- Generic outreach with low reply rates
- Inconsistent reporting from outreach to estimate close
...
## Why This Fits Painting

- `painting` is a configured target vertical in this repo (`market/target_verticals.json`).
- GTM angle: estimate velocity + close-rate uplift.
...
If you want, we can run a 7-day Painting pilot and review results in a single weekly dashboard.
