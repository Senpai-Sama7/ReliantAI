# Citadel for Landscaping Operators (Harris County, TX)

## What It Is

Citadel is a local-first outbound pipeline for Landscaping businesses that need more qualified conversations and better pipeline visibility.
...
Most Landscaping outbound efforts break in three places:
- Outbound lists not segmented by service fit
- Messaging does not differentiate recurring vs project work
- Poor tracking of outreach outcomes by territory
...
## Why This Fits Landscaping

- `landscaping` is a configured target vertical in this repo (`market/target_verticals.json`).
- GTM angle: route density + recurring-service expansion.
...
If you want, we can run a 7-day Landscaping pilot and review results in a single weekly dashboard.
